...
**Second project at the _neuefische Data Science_ bootcamp.**
...
The data used for this is: [flight delay dataset](https://zindi.africa/competitions/ai-tunisia-hack-5-predictive-analytics-challenge-2).
